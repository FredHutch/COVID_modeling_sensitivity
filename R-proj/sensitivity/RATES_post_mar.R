...
calib_params$vac_init_doy = 366+yday(ymd("2021-1-15"))     # Start of vaccination protection
calib_params$vac_end_ramp = 366+yday(ymd("2021-03-15"))  # Vax ramping continues to this date
calib_params$vac_start_rate = 1500			  # starting # w/ full doses (1 week lagged)
calib_params$vac_end_rate = 7500
calib_params$vac_final_rate = 10000
calib_params$delta12_doy = 366 + yday(ymd("2021-01-01"))    # Day to switch to dynamic SDs?
calib_params$DiagDate12 = 366+yday(ymd("2021-01-15"))
calib_params$Tests12 = mean_tests("2021-1-15")
calib_params$Pos12 = mean_pos("2021-01-15")
calib_params$rho_S10_1 = calib_params$rho_S6_1                  # Relative testing rate of susceptibles
calib_params$rho_S10_2 = calib_params$rho_S6_2 
calib_params$rho_S10_3 = calib_params$rho_S6_3 
calib_params$rho_S10_4 = calib_params$rho_S6_4 
calib_params$sd10_1 = calib_params$sd9_1                  # Social distancing (relaxed fit by age) 
calib_params$sd10_2 = calib_params$sd9_2
calib_params$sd10_3 = calib_params$sd9_3
calib_params$sd10_4 = calib_params$sd9_4
calib_params$h10_1 = calib_params$h9_1 
calib_params$h10_2 = calib_params$h9_2 
calib_params$h10_3 = calib_params$h9_3
calib_params$h10_4 = calib_params$h9_4
calib_params$cfr10_1 = 0
calib_params$cfr10_2 = calib_params$cfr9_2
calib_params$cfr10_3 = calib_params$cfr9_3
calib_params$cfr10_4 = calib_params$cfr9_4

# this loads the vaccination parameters
#source("kc_create_vac_scenario_params.R")
int_param_names = c("vac_final_rate","vac_on")
...
row.names(interventions) = c(
			"Vax Prot Rate=5k/day",
			"Vax Prot Rate=8k/day",
			"Vax Prot Rate=11k/day")
...
calib_params$calib_doy = yday(ymd("2020-12-31"))     # End of model calibration
...
pdf(paste0("to_dan/",suffix,".pdf"), width = 8, height=10)
par(mfrow=c(4,2),mar = 0.1 + c(3, 4, 1, 4), mgp = c(3, 0.5, 0), oma = c(3,2,0,0))
...
plot_scenarios(doy, cases, yday(the_data$date), the_data$cases, 
                #y_lab = "Daily Diagnosed Cases", x_lim = c(startx,endx), col_pal = cols, col_idx = 1:3,y_lim = c(0,1500),#lwd=lwds,
...
plot_scenarios(scenarios_out$doy, scenarios_out$inf, yday(the_data$date), NA, 
               y_lab = "Cumulative Infections", x_lim = x_lim, col_pal = cols, col_idx = 1:3,y_lim = c(0,0.5*the_pop),#lwd=lwds,
...
plot_scenarios(doy, cum_hosp, yday(the_data$date), NA, 
                y_lab = "Daily Hospitalizations", x_lim = x_lim, col_pal = cols, col_idx = 1:3,y_lim = c(0,200),#lwd=lwds,
               delta = NULL, vaccination_date = vac_init_doy, calib_date = calib_doy, scenarios_out$sd_2[,1], NULL)
...
plot_scenarios(doy, perc_inf, yday(the_data$date), NA, 
               y_lab = "% Daily Infections New Variant", x_lim = NULL, col_pal = cols, col_idx = 1:3,y_lim = c(0,100),#lwd=lwds,
...
plot_scenarios(scenarios_out$doy, scenarios_out$vax, yday(the_data$date), NA, 
                y_lab = "Total Vaccinated", x_lim = c(startx,endx), col_pal = cols, col_idx = 1:3,y_lim = c(0,the_pop),#lwd=lwds,
               delta = NULL, vaccination_date = vac_init_doy, calib_date = calib_doy, scenarios_out$sd_2[,1], totalpop = the_pop)
dev.off()
...
plot_scenarios(scenarios_out$doy, scenarios_out$vac_1, yday(the_data$date), NA, 
                y_lab = "Vaccinated (0-19)", x_lim = c(startx,endx), col_pal = cols, col_idx = 1:3,y_lim = c(0,1e6),#lwd=lwds,
               delta = NULL, vaccination_date = vac_init_doy, calib_date = calib_doy, scenarios_out$sd_2[,1], totalpop = 0)
plot_scenarios(scenarios_out$doy, scenarios_out$vac_2, yday(the_data$date), NA, 
                y_lab = "Vaccinated (20-49)", x_lim = c(startx,endx), col_pal = cols, col_idx = 1:3,y_lim = c(0,1e6),#lwd=lwds,
               delta = NULL, vaccination_date = vac_init_doy, calib_date = calib_doy, scenarios_out$sd_2[,1], totalpop = 0)
plot_scenarios(scenarios_out$doy, scenarios_out$vac_3, yday(the_data$date), NA, 
                y_lab = "Vaccinated (50-69)", x_lim = c(startx,endx), col_pal = cols, col_idx = 1:3,y_lim = c(0,1e6),#lwd=lwds,
               delta = NULL, vaccination_date = vac_init_doy, calib_date = calib_doy, scenarios_out$sd_2[,1], totalpop = 0)
plot_scenarios(scenarios_out$doy, scenarios_out$vac_4, yday(the_data$date), NA, 
                y_lab = "Vaccinated (seniors)", x_lim = c(startx,endx), col_pal = cols, col_idx = 1:3,y_lim = c(0,1e6),#lwd=lwds,
               delta = NULL, vaccination_date = vac_init_doy, calib_date = calib_doy, scenarios_out$sd_2[,1], totalpop = 0)
dev.off()
