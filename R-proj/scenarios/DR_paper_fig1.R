...
interventions = matrix(c( 150 * the_pop / 100000, 50 * the_pop / 100000,1,
		       225 * the_pop / 100000, 125 * the_pop / 100000,1,
		       300 * the_pop / 100000, 200 * the_pop / 100000,1,
		       450 * the_pop / 100000, 350 * the_pop / 100000,1,
		       750 * the_pop / 100000, 650 * the_pop / 100000,1),
                       byrow = TRUE, nrow = 5)
...
suffix=paste0(scen,"_vep_",vac_eff_pi,"_SD_",min_sd,"_to_",max_sd,"_rate_",rate,"_tot_",tot_vac)
print(suffix)
