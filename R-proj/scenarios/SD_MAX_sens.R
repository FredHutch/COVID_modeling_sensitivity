...
#
#In this case we are varying the limit for social distancing lockdown (SDmax in the literature) and holding
...
int_param_names = c("dynamic_sd_max","dynamic_sd_max_snrs","vac_on")
