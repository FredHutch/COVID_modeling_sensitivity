...
#
#In this case we are varying the minimum social distancing during release (SDmin in the literature) and 
...
int_param_names = c("dynamic_sd_min","dynamic_sd_min_snrs","vac_on")
